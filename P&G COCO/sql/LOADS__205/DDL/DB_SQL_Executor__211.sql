-- Nodo KNIME : P&G_COCO\LOADS (#205)\DB SQL Executor (#211)
-- Clave      : statement
...
if OBJECT_ID('tempdb.dbo.#ulae_co','U') is not null drop table #ulae_co
...
,'Change in ULAE' AS Concepto_nivel_1
...
,sum(p.valor_concepto)*m.[ULAE] VALOR_CONCEPTO
--,m.[Costo XL] AS load
--,'Load' origen
into #ulae_co
from #neta_co p
