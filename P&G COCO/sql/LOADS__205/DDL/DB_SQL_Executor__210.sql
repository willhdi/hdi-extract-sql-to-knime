-- Nodo KNIME : P&G_COCO\LOADS (#205)\DB SQL Executor (#210)
-- Clave      : statement
...
if OBJECT_ID('tempdb.dbo.#asistencias_co','U') is not null drop table #asistencias_co
...
,'Assistances' AS Concepto_nivel_1
,'TOTAL CLAIMS' as Concepto_nivel_0
,Marca_corretaje
,COD_INTERMEDIARIO
,PARTICIPACION
,COD_SUCURSAL
...
,sum(p.valor_concepto)*m.[Asistencias] VALOR_CONCEPTO
--,m.[Costo XL] AS load
--,'Load' origen
into #asistencias_co
from #neta_co p
