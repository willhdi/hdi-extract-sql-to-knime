-- Nodo KNIME : P&G_COCO\PREMIUM EARN (#298)\DB SQL Executor (#222)
-- Clave      : statement
...
into #caso1
from  #si_coco a
--left join [Liberty].[PROD].[DWH_CORRETAJE_H] b
--on (concat(ltrim(rtrim(A.RAMO_PROD)),'_',ltrim(rtrim(A.poliza)),'_',A.certificado))=(concat(ltrim(rtrim(b.cod_RAMO_PROD)),'_',ltrim(rtrim(b.nro_poliza)),'_',b.nro_certificado)) AND A.documento=B.documento 
