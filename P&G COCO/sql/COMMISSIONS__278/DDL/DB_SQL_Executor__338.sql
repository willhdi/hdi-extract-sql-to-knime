-- Nodo KNIME : P&G_COCO\COMMISSIONS (#278)\DB SQL Executor (#338)
-- Clave      : statement
...
if OBJECT_ID('tempdb.dbo.#cocorretaje_sucursal_r','U') is not null drop table #cocorretaje_sucursal_r
...
if OBJECT_ID('tempdb.dbo.#sucursal_r','U') is not null drop table #sucursal_r
...
if OBJECT_ID('tempdb.dbo.#cocorretaje_sn_r','U') is not null drop table #cocorretaje_sn_r
