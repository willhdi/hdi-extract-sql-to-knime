-- Nodo KNIME : P&G_COCO\GASTOS (#221)\DB SQL Executor (#66)
-- Clave      : statement
...
if OBJECT_ID('tempdb.dbo.#gastos_co','U') is not null drop table #gastos_co
...
,'UNALLOCATED UWE' AS Concepto_nivel_1
...
,p.Channel_Des
,p.[Tipo Canal]
,sum(p.valor_concepto)*m.[GASTOS] VALOR_CONCEPTO
,p.Canal_comercial
