-- Nodo KNIME : P&G_COCO\LOADS (#205)\DB SQL Executor (#213)
-- Clave      : statement
...
if OBJECT_ID('tempdb.dbo.#alae_co','U') is not null drop table #alae_co
...
,'Change in ALAE' AS Concepto_nivel_1
...
,sum(p.valor_concepto)*m.[ALAE] VALOR_CONCEPTO
--,m.[Costo XL] AS load
--,'Load' origen
into #alae_co
from #neta_co p
