-- Nodo KNIME : P&G_COCO\PREMIUM EARN (#64)\DB SQL Executor (#349)
-- Clave      : statement
...
set a.INTERMEDIARIO_LIDE = b.INTERMEDIARIO_LIDE
from #RT_reserva_inicial_terremoto a 
left join liberty_pruebas_actuaria.dbo.claves_por_poliza_2 b on a.sucursal_prod = b.sucursal_prod and a.poliza = b.poliza
where a.INTERMEDIARIO_LIDE is null
...
set a.INTERMEDIARIO_LIDE = b.INTERMEDIARIO_LIDE
from #RT_reserva_inicial_terremoto a 
left join liberty_pruebas_actuaria.dbo.claves_por_poliza_2 b on a.poliza = b.poliza
where a.INTERMEDIARIO_LIDE is null
