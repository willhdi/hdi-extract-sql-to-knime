-- Nodo KNIME : P&G_COCO\PREMIUM EARN (#64)\DB SQL Executor (#277)
-- Clave      : statement

USE Liberty_Pruebas_Actuaria

if OBJECT_ID('tempdb.dbo.#Final_t','U') is not null drop table #Final_t
...
into #Final_t
from  #RT_reserva_inicial_terremoto
group by 
LLAVE,
PERIODO_CONTABLE_ANALISIS,
SUCURSAL_PROD,
