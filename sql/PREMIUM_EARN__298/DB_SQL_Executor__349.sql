-- Nodo KNIME : P&G_COCO\PREMIUM EARN (#298)\DB SQL Executor (#349)
-- Clave      : statement
...
if OBJECT_ID('tempdb.dbo.#corretaje2','U') is not null drop table #corretaje2
...
if OBJECT_ID('tempdb.dbo.#cocorretaje_sucursal2','U') is not null drop table #cocorretaje_sucursal2
...
into #cocorretaje_sucursal2
from #change_comisiones_retorno a
...
if OBJECT_ID('tempdb.dbo.#sucursal2','U') is not null drop table #sucursal2


select 
--distinct
row_number() over(order by poliza,certificado,RECIBO) as id
,a.PERIODO_CONTABLE
,a.SUCURSAL_PROD
,a.RAMO_PROD
,a.POLIZA
